...
$result = pg_query_params($dbconn, 'UPDATE users SET quiz3_result = $1 WHERE email = $2', array("$quiz3_result", "$email"));
...
$result2 = pg_query_params($dbconn, 'SELECT quiz3_result FROM users WHERE email = $1', array("$email"));
